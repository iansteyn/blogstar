...
<nav id="side-nav">
  ...
  <div id="logo-container">
    <a id="nav-logo" class="nav-link" href="/?route=/home">
  ...
  <div id="middle-links">
    <a class="<?= hiddenIf(!$isAdmin) ?> nav-link" href="/?route=/admin">
