  ...
  <div class="post-summary-non-text">
    ...
    <div class="post-summary-button-group button-group-icon-only">
      <div class="interact-buttons">
        <button class="togglable-interaction-button button-icon-only" title="Like">
          <svg class="icon-inline" preserveAspectRatio="xMidYMid meet">
            <use href="../vector-icons/icons.svg#icon-like-unfilled"></use>
          </svg>
        </button>
        <button class="togglable-interaction-button button-icon-only button-icon-only-active hidden" title="Unlike">
          <svg class="icon-inline" preserveAspectRatio="xMidYMid meet">
            <use href="../vector-icons/icons.svg#icon-like-filled"></use>
          </svg>
        </button>
    
        <button class="togglable-interaction-button button-icon-only" title="Save">
          <svg class="icon-inline" preserveAspectRatio="xMidYMid meet">
            <use href="../vector-icons/icons.svg#icon-save-unfilled"></use>
          </svg>
        </button>
        <button class="togglable-interaction-button button-icon-only button-icon-only-active hidden" title="Unsave">
          <svg class="icon-inline" preserveAspectRatio="xMidYMid meet">
