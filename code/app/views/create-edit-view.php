...
<body>
  ...
  <main>
    ...
    <form class="panel create-panel" id="post-form" method="post" action="<?= $formAction ?>" enctype="multipart/form-data">
      ...
      <button class='post-button' id="submit-post-button" type="submit" value="Post">
        <?= $submitButtonText ?>
      </button>
      <a href="/blog-post/<?= $postData['post_id'] ?>" class="button-link">
        <input class='post-button' id="discard-button" type="button" value="<?= $isEditMode ? 'Cancel' : 'Discard' ?>">
      </a>
    </form>
  </main>
</body>
