...
<nav id="side-nav">
  ...
  <div id="top-links">
    ...
    <a class="<?= hiddenIf(!$isLoggedIn) ?> nav-link" href="<?= routeUrl('/profile') ?>">
      <svg class="icon-inline" preserveAspectRatio="xMidYMid meet"><use href="/../vector-icons/icons.svg#icon-profile"></use></svg>
      <span class="nav-link-text">Profile</span>
    </a>
    <a class="<?= hiddenIf(!$isLoggedIn) ?> nav-link" href="<?= routeUrl('/create') ?>">
  ...
  <div id="middle-links">
    <a class="<?= hiddenIf(!$isAdmin) ?> nav-link" href="<?= routeUrl('/admin') ?>">
